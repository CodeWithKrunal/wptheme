...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
	...
	<div class="shop_table shop_table_responsive">
		...
		<div class="cart-subtotal">
			<div class="cart-tit"><?php esc_html_e( 'Subtotal', 'woocommerce' ); ?></div>
		...
		<div class="order-total">
			<div class="cart-tit"><?php esc_html_e( 'Total', 'woocommerce' ); ?></div>
			<div class="cart-tit" data-title="<?php esc_attr_e( 'Total', 'woocommerce' ); ?>"><?php wc_cart_totals_order_total_html(); ?></div>
		</div>
